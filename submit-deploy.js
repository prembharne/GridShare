import { SorobanRpc, TransactionBuilder, Networks, BASE_FEE, Keypair } from '@stellar/stellar-sdk';
...
async function main() {
  ...
  // The XDR from --build-only (base64 encoded transaction envelope)
  const txXdr = "";
